...
namespace GLib {
	...
	public static uint8[] convert (uint8[] data, string to_codeset, string from_codeset, out size_t bytes_read = null) throws ConvertError;
	...
	[Compact]
	[CCode (cname = "FILE", free_function = "gtext_file_stream_free_file", cheader_filename = "stdio.h")]
	public class FileStream {
		[CCode (cname = "EOF", cheader_filename = "stdio.h")]
		public const int EOF;
		
		[CCode (cname = "fclose", cheader_filename = "stdio.h")]
		public int close();
		...
		[CCode (cname = "ftruncate", cheader_filename = "unistd.h")]
		public static int ftruncate (int fildes, long offset);
		...
		public long size {
			get {
				...
				seek (0, FileSeek.END);
				long len = tell();
				seek (pos, FileSeek.SET);
				return len;
			}
		}
		
		public bool truncate (long offset) {
			long s = size;
			if (s <= 0 || offset >= s)
				return false;
			int fd = fileno();
			return ftruncate (fd, offset) == 0;
		}
