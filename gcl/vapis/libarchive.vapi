...
namespace LibArchive {
	...
	[CCode (has_target = false, cname="archive_read_callback")]
	public delegate ssize_t ReadCallback (Archive archive, void* data, out void* buffer);
	...
	[CCode (has_target = false, cname="archive_write_callback")]
	public delegate ssize_t WriteCallback (Archive archive, void* data, [CCode (array_length_type = "gsize", array_length_cname = "_length")]uint8[] buffer);
	
	[CCode (cname="archive_open_callback", has_target = false)]
	public delegate int OpenCallback (Archive archive, void* data);

	[CCode (cname="archive_close_callback", has_target = false)]
	public delegate int CloseCallback (Archive archive, void* data);
	...
	public class Read : Archive {
		...
		public Result open (void* data, OpenCallback ocb, ReadCallback rcb, CloseCallback ccb);
		...
		public ssize_t read_data (uint8[] data);
	...
	public class Write : Archive {
		...
		public Result open (void* data, OpenCallback oc, WriteCallback wc, CloseCallback cc);
		...
		public ssize_t write_data ([CCode (array_length_type = "gsize")]uint8[] data);
		...
		public Result set_passphrase (string password);
		public Result set_options (string options);
	}
